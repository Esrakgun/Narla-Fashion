...
Narla Fashion; kadın çorapları, hosiery, seamless ürünler ve basic koleksiyonlara odaklanan modern bir Next.js 16 e-ticaret platformudur.
Marka kimliği: zarafet, minimalizm, ten tonları, doğal renk paleti ve modern tasarım.
...
✔ Ten çorapları (Nude Light – Nude Medium – Deep)
✔ Opak çoraplar (Black, Graphite)
✔ Soket / külotlu çoraplar
✔ Trend koleksiyonlar
✔ Seamless ürünler
✔ Renk varyantlı ürün kartları
✔ Kombin önerileri
...
5.Firebase 12 (Auth + Firestore + Storage)
...
MUI’nin stil altyapısıdır.
Tailwind’in yanında MUI component’leri özelleştirmek için gerekli.
...
📩 8) İletişim / Bize Ulaşın (EmailJS Entegrasyonu)
Kullanılan kütüphaneler
...
🎨 9) Renk – Beden – Varyant Sistemleri
Kullanılan kütüphaneler
...
🧮 11) Global Store (Zustand) – Teknik Mimarisi
Store’da tutulan veriler:
...
📍 12) Routing & Dynamic Routes (Next.js)
Teknik Yapı
...
👤 12) AccountMenu Component
Kullanım alanı

AccountPage içinde küçük grid kutuları
(Siparişlerim / Profil Bilgileri / Çıkış Yap vb.)
...
🔐 14) LoginForm / RegisterForm Components
Kullanılan teknolojiler
...
📩 15) ContactForm Component (EmailJS)
Teknik işlev
...
⛓ 21) Layout Components (RootLayout, ShopLayout vs.)
Teknik işlev
...
📦 22) Data Components (products.ts, colors.ts, categories.ts)
Teknik işlev
...
Önerilere açığım!
Yeni özellikler veya iyileştirmeler için issue/pull request gönderebilirsin.
